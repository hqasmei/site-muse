...
Subject to these Terms of Service (this "Agreement"), [sitemuse.co](/) ("SiteMuse", "we", "us" and/or "our") provides access to SiteMuse's cloud platform as a service (collectively, the "Services"). By using or accessing the Services, you acknowledge that you have read, understand, and agree to be bound by this Agreement.
...
By signing up and using the services provided by SiteMuse (referred to as the "Service"), you are agreeing to be bound by the following terms and conditions ("Terms of Service"). The Service is owned and operated by SiteMuse ("Us", "We", or "Our").

## 2. Description of Service

SiteMuse provides an open-source tool for developers and designers to manage bookmarks and streamline research and inspiration ("the Product"). The Product is accessible at sitemuse.co and other domains and subdomains controlled by Us (collectively, "the Website").
...
Questions or comments about the Website or these Terms of Service may be directed to our support team at hosna.qasmei@gmail.com.
